...
# pessoas que trabalham manobrando os veículos, iremos escrever um programa
# para que eles consigam adicionar novos veículos na garagem e retirar os
# veículos conforme a solicitação dos clientes. Escreva um programa que
# faça essas duas operações, inserção de veículos e a remoção do veículo
# desejado pela pessoa. Lembrando que os veículos que foram removidos para
# se chegar no veículo do cliente, ficam parados na rua e depois são adicionados
# na mesma ordem que estavam no estacionamento.
