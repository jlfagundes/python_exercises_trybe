# Exercício 5: Dado uma string , contendo letras e parênteses. Crie uma função que irá
# reverter os caracteres de tal forma que somente os caracteres dentro dos parênteses
# sejam revertidos. A string final não deve conter os parênteses. 
